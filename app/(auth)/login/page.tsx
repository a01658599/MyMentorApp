  ...
  return (
    <div className="flex-1 flex items-center justify-center p-6 bg-background">
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
        <h2 className="text-3xl font-heading font-bold text-slate-800 mb-6 text-center">Welcome Back</h2>
        <form className="space-y-4">
          ...
          <div className="flex flex-col gap-3 mt-6">
            <Link href="/dashboard" className="block w-full bg-primary text-white text-center font-bold py-3 rounded-lg hover:bg-primary/90 transition-colors">
              Log In as Student
            </Link>
            <Link href="/tutor-dashboard" className="block w-full bg-accent text-slate-900 text-center font-bold py-3 rounded-lg hover:bg-white border border-accent transition-colors">
              Log In as Tutor
            </Link>
          </div>
        </form>
